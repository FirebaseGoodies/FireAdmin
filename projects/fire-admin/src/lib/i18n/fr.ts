...
export const fr = {
  ...
  "Role": "Rôle",
  "Bio": "Bio",
  "BioPlaceholder": "Je suis ingénieur spécialisé dans la conception.",
  ...
  "TranslationsTooltip": "Les traductions peuvent être utilisées avec la bibiliothèque <a href=\"http://www.ngx-translate.com/\" target=\"_blank\">ngx-translate</a>, pour tout texte répétitif (en-tête, pied de page ou fil d'Ariane) qui doit être traduit.",
  // Error messages
